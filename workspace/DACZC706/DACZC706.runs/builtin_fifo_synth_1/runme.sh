...
HD_PWD='C:/Users/Projet/Desktop/Recherche/gallay_DACGenesys2/workspace/DACZC706/DACZC706.runs/builtin_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log builtin_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source builtin_fifo.tcl
