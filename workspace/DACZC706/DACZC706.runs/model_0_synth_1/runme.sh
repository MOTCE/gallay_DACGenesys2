...
HD_PWD='C:/Users/Projet/Desktop/Recherche/gallay_DACGenesys2/workspace/DACZC706/DACZC706.runs/model_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log model_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source model_0.tcl
