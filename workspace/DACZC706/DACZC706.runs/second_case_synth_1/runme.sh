...
HD_PWD='C:/Users/Projet/Desktop/Recherche/gallay_DACGenesys2/workspace/DACZC706/DACZC706.runs/second_case_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log second_case.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source second_case.tcl
