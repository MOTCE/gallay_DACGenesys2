...
HD_PWD='C:/Users/Projet/Desktop/Recherche/gallay_DACGenesys2/workspace/DACZC706/DACZC706.runs/example_sg_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log example_sg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source example_sg.tcl
