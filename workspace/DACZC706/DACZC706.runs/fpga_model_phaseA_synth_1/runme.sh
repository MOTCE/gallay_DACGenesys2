...
HD_PWD='C:/Users/Projet/Desktop/Recherche/gallay_DACGenesys2/workspace/DACZC706/DACZC706.runs/fpga_model_phaseA_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_model_phaseA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_model_phaseA.tcl
