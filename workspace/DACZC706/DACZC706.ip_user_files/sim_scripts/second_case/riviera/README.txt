...
#
# Generated by export_simulation on Wed Jun 23 16:45:49 -0400 2021
#
################################################################################
...
'-reset_run' switch to the './second_case.sh' script.

./second_case.sh -reset_run
...
./second_case.sh -noclean_files

For more information on the script, please type './second_case.sh -help'.
