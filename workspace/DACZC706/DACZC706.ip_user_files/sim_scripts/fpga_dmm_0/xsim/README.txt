...
#
# Generated by export_simulation on Mon Jun 21 08:47:25 -0400 2021
#
################################################################################
...
'-reset_run' switch to the './fpga_dmm_0.sh' script.

./fpga_dmm_0.sh -reset_run
...
./fpga_dmm_0.sh -noclean_files

For more information on the script, please type './fpga_dmm_0.sh -help'.
