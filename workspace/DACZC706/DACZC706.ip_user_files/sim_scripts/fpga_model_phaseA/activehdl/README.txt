...
#
# Generated by export_simulation on Wed Jun 23 10:57:10 -0400 2021
#
################################################################################
...
'-reset_run' switch to the './fpga_model_phaseA.sh' script.

./fpga_model_phaseA.sh -reset_run
...
./fpga_model_phaseA.sh -noclean_files

For more information on the script, please type './fpga_model_phaseA.sh -help'.
