...
#
# Generated by export_simulation on Wed Jun 23 12:37:22 -0400 2021
#
################################################################################
...
'-reset_run' switch to the './fpga_model_v2.sh' script.

./fpga_model_v2.sh -reset_run
...
./fpga_model_v2.sh -noclean_files

For more information on the script, please type './fpga_model_v2.sh -help'.
