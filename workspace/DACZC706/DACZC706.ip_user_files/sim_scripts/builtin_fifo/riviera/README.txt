...
#
# Generated by export_simulation on Sun Jun 20 13:59:43 -0400 2021
#
################################################################################
...
'-reset_run' switch to the './builtin_fifo.sh' script.

./builtin_fifo.sh -reset_run
...
./builtin_fifo.sh -noclean_files

For more information on the script, please type './builtin_fifo.sh -help'.
