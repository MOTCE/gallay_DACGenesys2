...
#
# Generated by export_simulation on Sat Jun 19 16:15:00 -0400 2021
#
################################################################################
...
'-reset_run' switch to the './model_0.sh' script.

./model_0.sh -reset_run
...
./model_0.sh -noclean_files

For more information on the script, please type './model_0.sh -help'.
