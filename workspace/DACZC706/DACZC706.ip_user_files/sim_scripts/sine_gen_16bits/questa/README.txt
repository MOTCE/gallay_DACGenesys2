...
#
# Generated by export_simulation on Sat Jun 19 12:44:37 -0400 2021
#
################################################################################
...
'-reset_run' switch to the './sine_gen_16bits.sh' script.

./sine_gen_16bits.sh -reset_run
...
./sine_gen_16bits.sh -noclean_files

For more information on the script, please type './sine_gen_16bits.sh -help'.
