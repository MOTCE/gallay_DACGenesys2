...
#
# Generated by export_simulation on Fri Jun 18 10:32:46 -0400 2021
#
################################################################################
...
'-reset_run' switch to the './WAVE_GEN.sh' script.

./WAVE_GEN.sh -reset_run
...
./WAVE_GEN.sh -noclean_files

For more information on the script, please type './WAVE_GEN.sh -help'.
